...
public class VehicleDao {
    ...
    public List<Vehicle> searchByPriceRange(double minPrice, double maxPrice) {
        ...
        String query = "SELECT * FROM vehicles v WHERE v.price BETWEEN ? AND ?;";
        try(Connection connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement(query)){
    ...
    public List<Vehicle> searchByMakeModel(String make, String model) {
        ...
        List<Vehicle> vehicles = new ArrayList<>();
        String query = "SELECT * FROM vehicles v WHERE v.make LIKE ? AND v.model LIKE ?;";
        try(Connection connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement(query)){
    ...
    public List<Vehicle> searchByYearRange(int minYear, int maxYear) {
        ...
        List<Vehicle> vehicles = new ArrayList<>();
        //Vehicle vehicle = null;
        String query = "SELECT * FROM vehicles v WHERE v.year BETWEEN ? AND ?;";
        try(Connection connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement(query)){
    ...
    public List<Vehicle> searchByColor(String color) {
        ...
        List<Vehicle> vehicles = new ArrayList<>();
        //Vehicle vehicle = null;
        String query = "SELECT * FROM vehicles v WHERE v.color LIKE ?;";
        try(Connection connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement(query)){
    ...
    public List<Vehicle> searchByMileageRange(int minMileage, int maxMileage) {
        ...
        List<Vehicle> vehicles = new ArrayList<>();
        //Vehicle vehicle = null;
        String query = "SELECT * FROM vehicles v WHERE v.mileage BETWEEN ? AND ?;";
        try(Connection connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement(query)){
    ...
    public List<Vehicle> searchByType(String type) {
        ...
        List<Vehicle> vehicles = new ArrayList<>();
        //Vehicle vehicle = null;
        String query = "SELECT * FROM vehicles v WHERE v.type LIKE ?;";
        try(Connection connection = dataSource.getConnection();
            PreparedStatement statement = connection.prepareStatement(query)){
